...
namespace URMARRY.Areas.Admin.Controllers
{
    ...
    public class ReligionController : Controller
    {
        ...
        public ReligionController(IRepository<ReligionCaste> repo, IMapper mapper)
        {
            _repo = repo;
            _mapper = mapper;
        }

        [HttpGet("/admin/religion")]
        public async Task<IActionResult> GetAll()
        {
            return View(_mapper.Map<List<ReligionCasteDto>>(await _repo.Where(x => x.ParentId == 0)));
        }

        [HttpGet("/admin/religion/{id:long}")]
        ...
        [HttpPost("/admin/religion/delete/{id:long}")]
